...
The core stack is the platform: Caddy, the BFFs (webapp, grid, assistant, roi,
community), the APIs (dataset-api, digital-twin, rec-registry, nudging, flexibility), the
five frontend apps, onboarding — plus the two things none of them run without, Postgres (celine-pipelines'
